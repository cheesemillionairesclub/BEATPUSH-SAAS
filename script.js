...
const translations = {
    en: {
        ...
        how_step3_detail: 'Beatpush connects your music with a private network of DJs, producers, and passionate electronic music collectors built over 10+ years in the industry. Our team monitors the campaign daily and tracks the chart activity and visibility of the release.',
        ...
        why_card1_text: 'Every purchase is 100% organic, made through real Beatport accounts, with full traceability and verified receipts.\n\nOur campaigns rely on a large, established global buyer network, trusted by artists and industry professionals worldwide.',
    ...
    fr: {
        ...
        how_step3_detail: 'Beatpush connecte votre musique à un réseau privé de DJs, producteurs et collectionneurs passionnés de musique électronique, construit en plus de 10 ans dans l\'industrie. Notre équipe surveille la campagne quotidiennement et suit l\'activité des charts et la visibilité de la sortie.',
        ...
        why_card1_text: 'Chaque achat est 100% organique, effectué via de vrais comptes Beatport, avec une traçabilité complète et des reçus vérifiés.\n\nNos campagnes s\'appuient sur un large réseau mondial d\'acheteurs établi, reconnu par les artistes et les professionnels de l\'industrie.',
    ...
    pt: {
        ...
        how_step3_detail: 'Beatpush conecta sua música a uma rede privada de DJs, produtores e colecionadores apaixonados por música eletrônica, construída ao longo de mais de 10 anos na indústria. Nossa equipe monitora a campanha diariamente e acompanha a atividade dos charts.',
        ...
        why_card1_text: 'Cada compra é 100% orgânica, feita através de contas reais do Beatport, com total rastreabilidade e recibos verificados.\n\nNossas campanhas contam com uma grande rede global de compradores estabelecida, confiada por artistas e profissionais da indústria em todo o mundo.',
    ...
    es: {
        ...
        how_step3_detail: 'Beatpush conecta tu música con una red privada de DJs, productores y coleccionistas apasionados de música electrónica, construida durante más de 10 años en la industria. Nuestro equipo monitorea la campaña diariamente y rastrea la actividad de los charts.',
        ...
        why_card1_text: 'Cada compra es 100% orgánica, realizada a través de cuentas reales de Beatport, con total trazabilidad y recibos verificados.\n\nNuestras campañas se basan en una amplia red global de compradores establecida, confiada por artistas y profesionales de la industria en todo el mundo.',
    ...
    de: {
        ...
        how_step3_detail: 'Beatpush verbindet deine Musik mit einem privaten Netzwerk aus DJs, Produzenten und leidenschaftlichen Sammlern elektronischer Musik, aufgebaut über mehr als 10 Jahre in der Branche. Unser Team überwacht die Kampagne täglich und verfolgt die Chart-Aktivität.',
        ...
        why_card1_text: 'Jeder Kauf ist 100% organisch, über echte Beatport-Konten getätigt, mit vollständiger Rückverfolgbarkeit und verifizierten Belegen.\n\nUnsere Kampagnen stützen sich auf ein großes, etabliertes globales Käufernetzwerk, dem Künstler und Branchenprofis weltweit vertrauen.',
