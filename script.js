...
const translations = {
    en: {
        ...
        faq1_q: 'How fast does promotion start?',
        faq1_a: 'Campaigns usually start within 24–48 hours after confirmation.',
        faq2_q: 'How long does a promotion campaign take?',
        faq2_a: 'Most campaigns are completed within 2 to 10 days, depending on chart competition.',
        faq3_q: 'Do you use bots?',
        faq3_a: 'No. Beatpush focuses on real promotion strategies and campaign management.',
        faq4_q: 'Can new artists use Beatpush?',
        faq4_a: 'Yes. We work with both emerging artists and established labels.',
        faq5_q: 'Do exclusive releases perform better?',
        faq5_a: 'In many cases yes, because all activity is concentrated on Beatport, which can strengthen chart momentum.',
    ...
    pt: {
        ...
        faq1_q: 'Quanto tempo leva para a promocao comecar?',
        faq1_a: 'As campanhas geralmente comecam dentro de 24 a 48 horas apos a confirmacao.',
        faq2_q: 'Quanto tempo dura uma campanha de promocao?',
        faq2_a: 'A maioria das campanhas e concluida em 2 a 10 dias, dependendo da competicao nos charts.',
        faq3_q: 'Voces usam bots?',
        faq3_a: 'Nao. O Beatpush foca em estrategias reais de promocao e gestao de campanhas.',
        faq4_q: 'Artistas novos podem usar o Beatpush?',
        faq4_a: 'Sim. Trabalhamos com artistas emergentes e selos estabelecidos.',
        faq5_q: 'Lancamentos exclusivos tem melhor desempenho?',
        faq5_a: 'Em muitos casos sim, porque toda a atividade se concentra no Beatport, o que pode fortalecer o impulso nos charts.',
    ...
    es: {
        ...
        faq1_q: 'Que tan rapido comienza la promocion?',
        faq1_a: 'Las campanas generalmente comienzan dentro de 24 a 48 horas despues de la confirmacion.',
        faq2_q: 'Cuanto dura una campana de promocion?',
        faq2_a: 'La mayoria de las campanas se completan en 2 a 10 dias, dependiendo de la competencia en los charts.',
        faq3_q: 'Usan bots?',
        faq3_a: 'No. Beatpush se enfoca en estrategias reales de promocion y gestion de campanas.',
        faq4_q: 'Pueden los nuevos artistas usar Beatpush?',
        faq4_a: 'Si. Trabajamos con artistas emergentes y sellos establecidos.',
        faq5_q: 'Los lanzamientos exclusivos tienen mejor rendimiento?',
        faq5_a: 'En muchos casos si, porque toda la actividad se concentra en Beatport, lo que puede fortalecer el impulso en los charts.',
    ...
    de: {
        ...
        faq1_q: 'Wie schnell beginnt die Promotion?',
        faq1_a: 'Kampagnen starten in der Regel innerhalb von 24 bis 48 Stunden nach Bestatigung.',
        faq2_q: 'Wie lange dauert eine Promotionskampagne?',
        faq2_a: 'Die meisten Kampagnen werden innerhalb von 2 bis 10 Tagen abgeschlossen, je nach Chart-Wettbewerb.',
        faq3_q: 'Verwenden Sie Bots?',
        faq3_a: 'Nein. Beatpush setzt auf echte Promotionsstrategien und Kampagnenmanagement.',
        faq4_q: 'Konnen neue Kunstler Beatpush nutzen?',
        faq4_a: 'Ja. Wir arbeiten sowohl mit aufstrebenden Kunstlern als auch mit etablierten Labels.',
        faq5_q: 'Haben exklusive Veroffentlichungen bessere Ergebnisse?',
        faq5_a: 'In vielen Fallen ja, da sich alle Aktivitaten auf Beatport konzentrieren, was die Chart-Dynamik starken kann.',
...
const frDefaults = {
    ...
    faq1_q: 'En combien de temps la promotion demarre-t-elle ?', faq1_a: 'Les campagnes demarrent generalement dans les 24 a 48 heures apres confirmation.',
    faq2_q: 'Combien de temps dure une campagne de promotion ?', faq2_a: 'La plupart des campagnes sont terminees en 2 a 10 jours, selon la competition dans les charts.',
    faq3_q: 'Utilisez-vous des bots ?', faq3_a: 'Non. Beatpush se concentre sur de vraies strategies de promotion et de gestion de campagnes.',
    faq4_q: 'Les nouveaux artistes peuvent-ils utiliser Beatpush ?', faq4_a: 'Oui. Nous travaillons aussi bien avec des artistes emergents qu\'avec des labels etablis.',
    faq5_q: 'Les sorties exclusives ont-elles de meilleurs resultats ?', faq5_a: 'Dans de nombreux cas oui, car toute l\'activite est concentree sur Beatport, ce qui peut renforcer la dynamique dans les charts.',
