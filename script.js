...
const translations = {
    en: {
        ...
        campaign_artists_hint_2: 'By understanding which artists your sound aligns with, we can target the right DJs, playlists, and audiences that are already engaging with this style of music.',
    ...
    fr: {
        ...
        campaign_artists_hint_2: 'En comprenant \u00e0 quels artistes votre son s\'apparente, nous pouvons cibler les bons DJs, playlists et audiences qui s\'int\u00e9ressent d\u00e9j\u00e0 \u00e0 ce style de musique.',
    ...
    pt: {
        ...
        campaign_artists_hint_2: 'Ao entender com quais artistas seu som se alinha, podemos direcionar os DJs, playlists e p\u00fablicos certos que j\u00e1 se envolvem com esse estilo de m\u00fasica.',
    ...
    es: {
        ...
        campaign_artists_hint_2: 'Al comprender con qu\u00e9 artistas se alinea tu sonido, podemos dirigirnos a los DJs, playlists y audiencias adecuados que ya interactúan con este estilo de m\u00fasica.',
    ...
    de: {
        ...
        campaign_artists_hint_2: 'Indem wir verstehen, mit welchen K\u00fcnstlern dein Sound \u00fcbereinstimmt, k\u00f6nnen wir die richtigen DJs, Playlists und Zielgruppen ansprechen, die sich bereits mit diesem Musikstil besch\u00e4ftigen.',
