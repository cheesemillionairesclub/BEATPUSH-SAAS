...
const translations = {
    en: {
        ...
        hero_title: 'Professional Beatport promotion for DJs, producers and <span class="text-gradient">labels.</span>',
    ...
    pt: {
        ...
        hero_title: 'Promocao profissional no Beatport para DJs, produtores e <span class="text-gradient">labels.</span>',
    ...
    es: {
        ...
        hero_title: 'Promocion profesional en Beatport para DJs, productores y <span class="text-gradient">sellos.</span>',
    ...
    de: {
        ...
        hero_badge: 'BEATPORT PROMOTION #1',
        hero_title: 'Professionelle Beatport-Promotion fur DJs, Produzenten und <span class="text-gradient">Labels.</span>',
...
const frDefaults = {
    ...
    hero_title: 'Promotion Beatport professionnelle pour DJs, producteurs et <span class="text-gradient">labels.</span>',
